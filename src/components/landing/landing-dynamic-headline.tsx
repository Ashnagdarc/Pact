    ...
    >
      <AnimatePresence mode="wait" initial={false}>
        <motion.span
          ...
          className={
            phase === "issue"
              ? "absolute inset-x-0 top-0 block text-white/45"
              : "absolute inset-x-0 top-0 block text-white"
          }
        >
          {phase === "issue" ? (
            <span className="block">
              <span className="mb-1.5 block text-[0.7rem] font-semibold tracking-[0.16em] text-coral-400/90 uppercase">
                The problem
              </span>
              {text}
            </span>
            ...
            <span className="block">
              <span className="mb-1.5 block text-[0.7rem] font-semibold tracking-[0.16em] text-volt-500/90 uppercase">
                With Pact
              </span>
              {text}
            </span>
